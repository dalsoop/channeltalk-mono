...
정본 기준: `../references/channeltalk-manual-philosophy.md`(스킬 루트 기준). SSOT: `surface.snapshot.json` 의 `features[]` + `/Users/jeonghan/Documents/WORK/WORKSPACE/apps/channeltalk-mono/main/CHANNELTALK.md`(§12 표면 시드). 출력: `../schemas/accuracy-verdict.schema.json`.
